...
public class BinarySearchTree<T extends Comparable<T>>{
    ...
    */
	...
	/**
	 * The purpose of this method is to return the maximum element of the tree.
	 * @return maximum element present in the tree.
	 */
    public T findMax(){

		//creating a reference of the tree created so that the location of
		// original tree elements is not affected.
		BinaryTree<T> tempTree = tree;

		//checking if the tree is empty, if not iterating through the right
		//branch of the tree since the nodes of right branch are greater than the node.
		if(tempTree.isEmpty()) {
			return null;
		}
		else {
			...
			return tempTree.getData();
		}
    }

	/**
	 * The purpose of this method is to return the minimum element of the tree.
	 * @return minimum element present in the tree.
	 */
    public T findMin(){
		...
		//checking if the tree is empty, if not iterating through the left
		//branch of the tree since the nodes of left branch are smaller than the node.
		if(tempTree.isEmpty()) {
			return null;
		}else {
	...
	/**
	 * The purpose of this method is to check whether an element is present in the array or not.
	 * @return null if the element is present, node containing the element otherwise.
	 */
